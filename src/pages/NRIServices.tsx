...
const process = [
  {
    ...
    title: "Consultation",
    description:
      "Share your requirements and preferences with our expert consultants.",
  },
  {
    step: "02",
    title: "Property Matching",
    description:
      "We curate a list of properties that perfectly match your criteria.",
  },
  {
    step: "03",
    title: "Site Visits",
    description:
      "Experience the properties firsthand with personalized site tours.",
  },
  {
    step: "04",
    title: "Documentation",
    description:
      "Complete legal and financial documentation with our assistance.",
  },
  {
    step: "05",
    title: "Possession",
    ...
    <div className="pt-24">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="absolute bottom-8 left-8 right-8 p-6 glass-gold rounded-lg">
                <p className="text-gold text-3xl font-display font-bold">
                  500+
                </p>
                <p className="text-foreground/80">
                  Happy families found their dream homes with us
                </p>
              </div>
            </motion.div>
          </div>
      ...
      <section className="py-24 bg-gradient-gold">
        <div className="container mx-auto px-6 text-center">
          ...
          >
            Let our experts help you find the perfect property. Schedule a free
            consultation today.
          </motion.p>
          <Link to="/contact">
            <motion.button
